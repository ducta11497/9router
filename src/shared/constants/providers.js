...
export const APIKEY_PROVIDERS = {
  krouter: { id: "krouter", alias: "krouter", name: "Krouter", icon: "router", color: "#F97316", textIcon: "KR", website: "https://api.krouter.net", notice: { text: "Krouter API key with usage quota tracking via check-usage endpoint.", apiKeyUrl: "https://api.krouter.net" }, serviceKinds: ["llm"], passthroughModels: true },
